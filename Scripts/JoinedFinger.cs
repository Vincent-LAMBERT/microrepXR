...
namespace Microgestures 
{
    ...
    public class IndexJoinedRing : ThreeZonesActor
    {
        public override ActorEnum[] getActorTypes()
            { return new ActorEnum[2]{
                ActorEnum.IndexJoinedRing,
                ActorEnum.RingJoinedIndex};
            }
        public IndexJoinedRing(Handedness handedness) : base(handedness){}
    ...
    public class LittleJoinedMiddle : ThreeZonesActor
    {
        public override ActorEnum[] getActorTypes()
            { return new ActorEnum[2]{
                ActorEnum.MiddleJoinedLittle,
                ActorEnum.LittleJoinedMiddle};
            }
        public LittleJoinedMiddle(Handedness handedness) : base(handedness){}
    ...
    public class IndexJoinedLittle : ThreeZonesActor
    {
        public override ActorEnum[] getActorTypes()
            { return new ActorEnum[2]{
                ActorEnum.IndexJoinedLittle,
                ActorEnum.LittleJoinedIndex};
            }
        public IndexJoinedLittle(Handedness handedness) : base(handedness){}
